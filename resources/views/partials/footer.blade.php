    ...
    <div class="max-w-7xl mx-auto px-6 py-10">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div class="md:col-span-2">
                @include('partials.logo', ['size' => 'md', 'showText' => true, 'textColor' => 'white'])
            ...
            <div>
                ...
                <ul class="space-y-2 text-xs text-slate-400">
                    <li><a href="{{ route('katalog') }}" class="hover:text-orange-500">Katalog Produk</a></li>
                    <li><a href="{{ url('/') }}#simulator" class="hover:text-orange-500">Sistem Pakar</a></li>
                    <li><a href="{{ route('register') }}" class="hover:text-orange-500">Daftar</a></li>
                </ul>
            </div>
            <div>
