...
@section('title', 'Masuk - AtapIndonesia')
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-slate-900/80 backdrop-blur border border-slate-800 p-8 rounded-2xl shadow-2xl space-y-6">
            <div class="text-center">
                <h2 class="text-2xl font-black text-white uppercase tracking-widest">Selamat Datang</h2>
                <p class="text-xs text-slate-400 mt-2">Masuk untuk mengakses Dashboard Mitra Anda</p>
            </div>
            ...
            <form action="{{ route('login.proses') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="nama@email.com" class="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2.5 text-xs text-white focus:outline-none focus:border-orange-500 transition" required autofocus>
                </div>
                <div>
                    <label class="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1.5">Kata Sandi</label>
                    <div class="relative">
                        <input type="password" name="password" placeholder="••••••••" class="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2.5 pr-10 text-xs text-white focus:outline-none focus:border-orange-500 transition" required id="login-password">
                        <button type="button" onclick="togglePassword('login-password', this)" class="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-white transition">
                ...
                <div class="flex items-center justify-between text-[11px]">
                    <label class="flex items-center gap-2 text-slate-400 cursor-pointer">
                        <input type="checkbox" class="rounded bg-slate-950 border-slate-800 text-orange-500 focus:ring-orange-500"> Ingat saya
                    </label>
                    <a href="mailto:atap.idn@gmail.com?subject=Lupa%20Password&body=Halo%20admin,%20saya%20lupa%20password%20akun%20saya." class="text-orange-500 font-bold hover:underline">Lupa sandi? Hubungi admin</a>
                </div>
            ...
            <p class="text-center text-[11px] text-slate-500">
                Belum punya akun? <a href="{{ route('register') }}" class="text-orange-500 hover:underline font-bold">Daftar di sini</a>
            </p>
            ...
            <div class="relative py-2">
                ...
                <div class="relative flex justify-center text-xs">
                    <span class="px-2 bg-slate-900 text-slate-500">Atau masuk dengan</span>
                </div>
            </div>
